...
import static org.openhab.binding.greeair.GreeAirBindingConstants.GREE_THING_TYPE;
...
public class GreeAirHandlerFactory extends BaseThingHandlerFactory {
    ...
    private static final Set<ThingTypeUID> SUPPORTED_THING_TYPES_UIDS = Collections.singleton(GREE_THING_TYPE);
